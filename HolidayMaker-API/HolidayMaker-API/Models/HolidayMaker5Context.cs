...
{
    public partial class HolidayMaker5Context : DbContext
    {
        public HolidayMaker5Context()
        {
        }

        public HolidayMaker5Context(DbContextOptions<HolidayMaker5Context> options)
            : base(options)
        {
        }
